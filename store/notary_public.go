...
// GetNotaryAccount is a free data retrieval call binding the contract method 0x3a693ba8.
//
// Solidity: function getNotaryAccount(uint256 appID) view returns(bool, address)
func (_NotaryPublicStore *NotaryPublicStoreCaller) GetNotaryAccount(opts *bind.CallOpts, appID *big.Int) (bool, common.Address, error) {
	var out []interface{}
	err := _NotaryPublicStore.contract.Call(opts, &out, "getNotaryAccount", appID)
...
//
// Solidity: function getNotaryAccount(uint256 appID) view returns(bool, address)
func (_NotaryPublicStore *NotaryPublicStoreSession) GetNotaryAccount(appID *big.Int) (bool, common.Address, error) {
	return _NotaryPublicStore.Contract.GetNotaryAccount(&_NotaryPublicStore.CallOpts, appID)
}

// GetNotaryAccount is a free data retrieval call binding the contract method 0x3a693ba8.
//
// Solidity: function getNotaryAccount(uint256 appID) view returns(bool, address)
func (_NotaryPublicStore *NotaryPublicStoreCallerSession) GetNotaryAccount(appID *big.Int) (bool, common.Address, error) {
	return _NotaryPublicStore.Contract.GetNotaryAccount(&_NotaryPublicStore.CallOpts, appID)
}
