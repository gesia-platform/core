...
export const CalculatorDetails = ({ voucherID, tokenNo }: { voucherID: string; tokenNo: string }) => {
	...
	const calculations = useGetCalculation({ voucherID, chainID, tokenNo, pageOffset: page.offset, pageSize: page.size });
	...
	return (
		...
		// 			<DetailsRow label='Calculator Name'>'Calculator Name'</DetailsRow>
		// 		</DetailsRows>
		// 	</Details>
		// 	<div className='mt-5'>
		// 		{isLoading ? (
