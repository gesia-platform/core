...
contract EggCarbonEmissionsCalculator is NotaryModule {
    uint256 EMISSIONS_PER_DOZEN = 24000000; // scaled by 1,000,000,000
    ...
    function calculate(
        ...
        uint256 result = EMISSIONS_PER_DOZEN * (value * 10e4) / 10e4;
