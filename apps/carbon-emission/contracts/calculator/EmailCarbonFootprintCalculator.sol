...
contract EmailCarbonFootprintCalculator is ApplicationAuthGuard {
    uint256 EMISSIONS_PER_EMAIL = 40; // scaled by 10,000
    ...
    function calculate(
        ...
        uint256 result = EMISSIONS_PER_EMAIL * (value * 10e4);
